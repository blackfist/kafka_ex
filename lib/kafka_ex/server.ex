defmodule KafkaEx.Server do
  ...
  def init([args, name]) do
    ...
    {:ok, helper_state} = init_helper([args, name])
    state = %State{helper_state | consumer_group: consumer_group, consumer_group_update_interval: consumer_group_update_interval}
